...
class ArgumentElement extends Element {
  ArgumentElement(this._argument, this.parent) : super() {
    if (this._argument.valueOrVariable.value != null) {
      _value = ValueElement(this._argument.valueOrVariable.value);
    } else {
      _variable = VariableElement(this._argument.valueOrVariable.variable);
    }
  }
